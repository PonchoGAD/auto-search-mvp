...
CITY_BLACKLIST = {
    ...
    "domodedovo",
    "krasnogorsk",
    # Подмосковные города-омонимы с брендами
    "vidnoe",
    "видное",
    "балашиха",
    "balashikha",
...
# Только явные признаки запчастей/ремонта (НЕ слова описания авто при продаже)
SPAM_PATTERNS = [
    "запчасти", "разбор", "по запчастям",
    "ремонт", "подскажите", "вопрос", "приобрету",
    "сервис", "колодки", "ваносы", "ксентри", "xentry", "кодирование", "чиптюнинг", "чип тюнинг"
]
